...
namespace FrbaCommerce
{
    public abstract class ABMEspecifico
    {
        ...
        public virtual string mensajeErrorValidacion()
        {
            return "Los datos ingresados no cumplen con las validaciones de la entidad a grabar.";
        }

        public virtual bool pasaValidacion()
        {
            return true;
        }
        ...
        {
            return this.getPanel(new Size(350, 520));
        }

        public virtual int getIdParaDevolver()
        {
            return 0;
        }
