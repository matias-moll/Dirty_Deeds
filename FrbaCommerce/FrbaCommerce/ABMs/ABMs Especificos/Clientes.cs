...
namespace FrbaCommerce
{
    public class Clientes : ABMEspecifico
    {
        ...
        protected override void grabarAlta()
        {
            ...
            unCliente.autoId = unCliente.save();
            Usuario unUsuario = crearUsuario(unCliente);
        ...
        {
            return new Usuario_Rol(unUsuario.autoId, 3);
        }
        ...
        private Usuario crearUsuario(Cliente cliente)
        {
            Usuario usuarioADarDeAlta = new Usuario(cliente.campoDocumento.ToString(),Hash.getHashSha256("Password"));
            usuarioADarDeAlta.campoIdReferencia = cliente.autoId;
